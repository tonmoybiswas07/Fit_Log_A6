...
import { FaFire, FaStar, FaRegClock, FaBookmark } from "react-icons/fa";
      ...
      <div className="flex flex-col gap-4 p-3 sm:flex-row sm:items-center sm:p-4">
        ...
        <div className="flex w-full shrink-0 sm:w-auto">
          ...
          <Link
            ...
            className="flex h-10 w-full items-center justify-center rounded-full border border-[#343944] px-5 text-xs font-bold text-white transition-all duration-300 hover:border-[#c2ff29] hover:bg-[#c2ff29] hover:text-black sm:w-auto sm:text-sm"
          >
            View Details
          </Link>
